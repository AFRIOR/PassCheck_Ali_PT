...
def Gen_DeviceToken(SessionId,AES_Key,Version_Code,timestamps:list,GatherCost):
    ...
    env_data=f"W.10051#####Linux aarch64#WeChat#8.0.70.3060#############8#{key}###########b5edd5be394adaca15866d8a285a8847##8##Android#14#####123.152.213.20#10-0|11-113|20-114|23-295|30-297|40-311|41-2814|70-2815|71-813|80-813#true###889*400##5##################saf-captcha#0###AcXaauXsImO6Ez2H9johSbbpMNBb0Co37dw5mvAz#{timestamps[0]}#HHz3uOBqluzi1Z1wFMQlXI3Ph6kHWWT89r1t4HUlMx#{timestamps[1]}#mobile#false##9d4568c009d203ab10e33ea9953a0264#########{timestamps[2]}#MCMwIzAjMCMwIzAjMCMwIzAjMCMwIzAjMCMwIzAjMCMwIzAjMCMxIzEjMCMxMTExMTEwMDExMTExMTExMTExMTExMTExMQ==#1#1#true##################-1#######################"
